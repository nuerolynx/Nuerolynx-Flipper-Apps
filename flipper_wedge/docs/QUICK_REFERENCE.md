...
Documentation:
  ...
  docs/ARCHITECTURE_PATTERNS.md   Architecture and maintenance patterns
...
# (See docs/TESTING_AUTOMATION.md)
```
...
```
[ ] docs/ARCHITECTURE_PATTERNS.md - Update if architecture or patterns changed
...
**Project Docs**:
- [ARCHITECTURE_PATTERNS.md](ARCHITECTURE_PATTERNS.md) - Architecture and maintenance patterns
